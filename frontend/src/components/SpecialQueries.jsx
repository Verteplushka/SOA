...
export default function SpecialQueries() {
  ...
  const validateMeters = (value) => {
    ...
    else if (value.length > MAX_INT_LENGTH) err = `Максимум ${MAX_INT_LENGTH} цифр`;
  ...
  const validatePrefix = (value) => {
    ...
    else if (value.length > MAX_NAME_LENGTH) err = `Максимальная длина — ${MAX_NAME_LENGTH} символов`;
  ...
  const validateAge = (value) => {
    let err = "";
    if (!/^\d+$/.test(value)) err = "Введите целое число";
    else if (Number(value) < 1 || Number(value) > 99) err = "Возраст должен быть от 1 до 99";
      ...
      <div className="container my-4">
        ...
        <div className="card mb-4 shadow-sm">
          <div className="card-body">
            ...
            {validationErrors.meters && <div className="invalid-feedback d-block">{validationErrors.meters}</div>}
          ...
          <div className="card-body">
            ...
            <div className="input-group mb-2">
              <input
                  ...
                  placeholder="prefix"
                  value={prefix}
                  onChange={(e) => { setPrefix(e.target.value); validatePrefix(e.target.value); }}
              />
              <button className="btn btn-primary" onClick={handleByName}>Найти</button>
            </div>
            {validationErrors.prefix && <div className="invalid-feedback d-block">{validationErrors.prefix}</div>}
        ...
        <div className="card mb-4 shadow-sm">
          <div className="card-body">
            <h3 className="card-title mb-3">Поиск городов с губернатором старше заданного возраста</h3>
            <div className="input-group mb-2">
              <input
                  type="text"
              ...
              />
              <button className="btn btn-warning" onClick={handleByAge}>Найти</button>
            </div>
            {validationErrors.age && <div className="invalid-feedback d-block">{validationErrors.age}</div>}
